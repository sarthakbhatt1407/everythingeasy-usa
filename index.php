...
<head>
  ...
  <!-- Favicon -->
  <link rel="icon" type="image/png" href="../everything-easy/images/logo.jpg" />
  <link rel="apple-touch-icon" sizes="180x180" href="apple-touch-icon.png" />
  <link rel="manifest" href="site.webmanifest" />
  <meta name="theme-color" content="#004da6" />

  <!-- Open Graph -->
  <meta property="og:title" content="EverythingEasy – Web Development & IT Solutions Company USA" />
...
<body>
  ...
  <main style="margin-top: 70px">
    <!-- Hero Section -->
    <section id="home" class="py-5" style="
          background: #004da6;
          color: white;
          min-height: 600px;
          display: flex;
        ...
        <div class="row align-items-center">
          <div class="col-lg-6 mb-4 mb-lg-0">
            ...
            <h1 style="
                ...
                ">
              Creative & Innovative
              <span style="color: #ffd700; display: block">Digital Solutions</span>
            </h1>
            <p style="
                  font-size: 16px;
                  line-height: 1.8;
    ...
    <!-- Stats Section -->
    <section class="py-5" style="background: white; box-shadow: 0 -10px 30px rgba(0, 0, 0, 0.05)">
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-6 mb-4">
            <div style="
              ...
              <h5 style="font-weight: 700; color: #333; margin-bottom: 15px">
                <i class="fas fa-rocket" style="color: #004da6; margin-right: 12px"></i>Quick Turnaround
              </h5>
          ...
          <div class="col-md-6 mb-4">
            <div style="
                ...
                ">
              <h5 style="font-weight: 700; color: #333; margin-bottom: 15px">
                <i class="fas fa-chart-line" style="color: #004da6; margin-right: 12px"></i>Results-Driven
              </h5>
              <p style="color: #666; margin-bottom: 0">
          ...
          <div class="col-md-6 mb-4">
            <div style="
                ...
                ">
              <h5 style="font-weight: 700; color: #333; margin-bottom: 15px">
                <i class="fas fa-users" style="color: #004da6; margin-right: 12px"></i>Expert Team
              </h5>
              <p style="color: #666; margin-bottom: 0">
          ...
          <div class="col-md-6 mb-4">
            <div style="
                ...
                ">
              <h5 style="font-weight: 700; color: #333; margin-bottom: 15px">
                <i class="fas fa-headset" style="color: #004da6; margin-right: 12px"></i>24/7 Support
              </h5>
              <p style="color: #666; margin-bottom: 0">
      ...
      <div class="container">
        ...
        <div class="text-center mt-5">
          <div style="
            ...
            <a href="#quote" class="btn btn-light btn-lg" style="font-weight: 600">Request a Quote</a>
          </div>
        </div>
      </div>
    </section>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 mb-4">
            <div class="pricing-card" style="
              ...
              <h2 style="color: #004da6; font-weight: 700; margin-bottom: 5px">
                $99
              </h2>
              ...
              <ul style="
                ...
                <li style="
                      ...
                      font-size: 14px;
                    ">
                  <i class="fas fa-check" style="color: #004da6; margin-right: 10px"></i>5 Web Pages
                </li>
                <li style="
                      padding: 10px 0;
                      border-bottom: 1px solid #e0e0e0;
                      ...
                      font-size: 14px;
                    ">
                  <i class="fas fa-check" style="color: #004da6; margin-right: 10px"></i>Basic SEO
                </li>
                <li style="
                      padding: 10px 0;
                      border-bottom: 1px solid #e0e0e0;
                      ...
                      font-size: 14px;
                    ">
                  <i class="fas fa-check" style="color: #004da6; margin-right: 10px"></i>SSL Certificate
                </li>
                <li style="padding: 10px 0; color: #666; font-size: 14px">
                  <i class="fas fa-check" style="color: #004da6; margin-right: 10px"></i>Email Support
                </li>
              </ul>
              <a href="#quote" class="btn w-100" style="
                    font-weight: 600;
                    background: white;
                    color: #004da6;
            ...
            <div class="pricing-card" style="
              ...
              <ul style="
                ...
                <li style="
                      ...
                      font-size: 14px;
                    ">
                  <i class="fas fa-check" style="margin-right: 10px"></i>E-commerce Setup
                </li>
                <li style="
                      padding: 10px 0;
                      border-bottom: 1px solid rgba(255, 255, 255, 0.2);
                      font-size: 14px;
                    ">
                  <i class="fas fa-check" style="margin-right: 10px"></i>Advanced SEO
                </li>
                <li style="padding: 10px 0; font-size: 14px">
                  <i class="fas fa-check" style="margin-right: 10px"></i>Priority Support
                </li>
              </ul>
              <a href="#quote" class="btn w-100" style="
                    font-weight: 600;
            ...
            <div class="pricing-card" style="
              ...
              <ul style="
                ...
                <li style="
                      ...
                      font-size: 14px;
                    ">
                  <i class="fas fa-check" style="color: #004da6; margin-right: 10px"></i>30 Web Pages
                </li>
                <li style="
                      padding: 10px 0;
                      border-bottom: 1px solid #e0e0e0;
                      ...
                      font-size: 14px;
                    ">
                  <i class="fas fa-check" style="color: #004da6; margin-right: 10px"></i>Advanced E-commerce
                </li>
                <li style="
                      padding: 10px 0;
                      border-bottom: 1px solid #e0e0e0;
                      ...
                      font-size: 14px;
                    ">
                  <i class="fas fa-check" style="color: #004da6; margin-right: 10px"></i>Marketing Tools
                </li>
                <li style="padding: 10px 0; color: #666; font-size: 14px">
                  <i class="fas fa-check" style="color: #004da6; margin-right: 10px"></i>Phone & Email Support
                </li>
              </ul>
              <a href="#quote" class="btn w-100" style="
                    font-weight: 600;
            ...
            <div class="pricing-card" style="
              ...
              <ul style="
                ...
                <li style="
                      ...
                      font-size: 14px;
                    ">
                  <i class="fas fa-check" style="color: #004da6; margin-right: 10px"></i>Unlimited Pages
                </li>
                <li style="
                      padding: 10px 0;
                      border-bottom: 1px solid #e0e0e0;
                      ...
                      font-size: 14px;
                    ">
                  <i class="fas fa-check" style="color: #004da6; margin-right: 10px"></i>Custom Development
                </li>
                <li style="
                      padding: 10px 0;
                      border-bottom: 1px solid #e0e0e0;
                      ...
                      font-size: 14px;
                    ">
                  <i class="fas fa-check" style="color: #004da6; margin-right: 10px"></i>API Integrations
                </li>
                <li style="padding: 10px 0; color: #666; font-size: 14px">
                  <i class="fas fa-check" style="color: #004da6; margin-right: 10px"></i>24/7 Phone Support
                </li>
              </ul>
              <a href="#quote" class="btn btn-primary w-100" style="
                    font-weight: 600;
                    background: #004da6;
                    margin-top: 15px;
                    display: block;
    ...
    <!-- Quote Section -->
    <section id="quote" class="py-5" style="
          background: linear-gradient(135deg, #004da6 0%, #003399 100%);
          color: white;
        ">
      <div class="container">
